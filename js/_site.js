...
(function() {
  var callBackFormModalOpen, enableCallBackForm, enableQuestionForm, formModalClose, iSendAJAX, mobileNav, questionFormModalOpen, smoothScroll;
  ...
  formModalClose = function() {
    $('.modal_form__wrap').on('click', function() {
      return $(this).removeClass('is_open');
    });
  };
