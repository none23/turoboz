...
(function() {
  var callBackFormModalOpen, enableCallBackForm, enableContactForm, enableOrderForm, enableQuestionForm, enableReviewForm, iSendAJAX, ifExistsEnableContactForm, ifExistsEnableOrderForm, ifExistsEnableReviewForm, mobileNav, smoothScroll;

  callBackFormModalOpen = function() {
    $('#call_back__toggle').on('click', function() {
      return $('#call_back__wrap').addClass('is_open');
    });
  };
